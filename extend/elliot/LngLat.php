...
//        $strrpos_lng = strrpos(rad2deg($result['lng']), '.') + 6;
//        $strrpos_lat = strrpos(rad2deg($result['lat']), '.') + 5;
//
//        $result['lng'] = substr($result['lng'], 0, $strrpos_lng);
//        $result['lat'] = substr($result['lat'], 0, $strrpos_lat);
        return $result;
    }
